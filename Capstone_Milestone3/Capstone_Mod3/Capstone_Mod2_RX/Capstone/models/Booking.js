...
// kept this focused on data I need to show and store; no business rules here beyond validation

class Booking {
  constructor({ pet, customer, daysStay, grooming = null, amountDue = 0 }) {
    // pet and customer must exist (I store small snapshots, not the whole doc)
    ...
    // I do not calculate price here; that is service logic
